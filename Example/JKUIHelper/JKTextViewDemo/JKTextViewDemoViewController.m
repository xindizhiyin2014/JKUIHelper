//
//  JKTextViewDemoViewController.m
//  JKUIHelper_Example
//
...
@interface JKTextViewDemoViewController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong) UITableView *contentTableView;
@property (nonatomic,strong) NSArray *dataArray;
@end

@implementation JKTextViewDemoViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    NSString *vcClassName = [NSString stringWithFormat:@"JKVCB%lu",indexPath.row];
